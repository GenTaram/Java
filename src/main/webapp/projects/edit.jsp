...
<head>
  ...
  <title>Taram | Project Edit</title>
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <select id="inputStatus" name="status" class="form-control custom-select">
                  ...
                  <option ${pDto.status == 'On Hold' ? 'selected' : ''}>On Hold</option>
                  <option ${pDto.status == 'Canceled' ? 'selected' : ''}>Canceled</option>
                  <option ${pDto.status == 'Success' ? 'selected' : ''}>Success</option>
                </select>
              </div>
              <div class="form-group">
                <label for="inputClientCompany">Client Company</label>
                <input type="text" id="inputClientCompany" name="client-company" class="form-control" value="${pDto.clientCompany}">
              </div>
              <div class="form-group">
                <label for="inputProjectLeader">Project Leader</label>
                <input type="text" id="inputProjectLeader" name="project-leader" class="form-control" value="${pDto.projectLeader}" readonly>
              </div>
            </div>
            <!-- /.card-body -->
          </div>
